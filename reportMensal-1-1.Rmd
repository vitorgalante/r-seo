...
# aqui, temos atualmente um script focado em criar analises mensais
# Para utilizar-la basta exportar um arquivo do GSC
# futuramente esse código pode ser melhorado fazendo o seguintes pontos
# - Desenvolver os códigos que permitem se conctar diretamente no serviços da google
# - talvez desenvolvover funções que permitam o calculo de projeções
# - evolui-lo par
...
# COMO FUNCIONA -> ela extraí o que se econtra na string de URL entre o dominio e o endereço FAQ
# precisa ser feito alguns ajustes nela
# preciso incluir uma regra para que ela coloque as páginas de categoria pai
# sejam inclusas dentro das categorias, ou mesmo ser marcada como página de 
# categoria, dessa forma ela pode performar melhor

extrair_categoria <- function(url) {
  str_extract(url, "(?<=/faq/)[^/]+") #altere /faq/ para o separador de categoria do seu site caso haja.
}

# Função para categorizar a posição em tiers - essa aqui ta funcionando bem.
# básicamente ela categoriza a variavel de posição
