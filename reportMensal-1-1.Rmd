...
``` {r Análise Geral do Mês Atual}
# Análise Geral do Mês Atual
mes_atual <- meses[length(meses)]  # Último mês da lista
metricas_mes_atual <- metricas_por_mes[[mes_atual]]

cat("## Análise Geral de", mes_atual, "\n\n")

cat("**Total de cliques em", mes_atual, ":", metricas_mes_atual$total_cliques, "**\n\n")
cat("**Total de impressões em", mes_atual, ":", metricas_mes_atual$total_impressoes, "**\n\n")
cat("**Posição média em", mes_atual, ":", round(metricas_mes_atual$posicao_media, 2), "**\n\n")
cat("**Quantidade de keywords em", mes_atual, ":", metricas_mes_atual$total_keywords, "**\n\n")
cat("**Quantidade de páginas em", mes_atual, ":", metricas_mes_atual$total_paginas, "**\n\n")
```

```{r Visualização Geral por Tier}
...
if (length(meses) >= 2) {
  ...
  cat("## Comparação entre", mes_anterior, "(mês anterior) e", mes_atual, "(mês atual)\n\n")
  ...
  cat("**Posição média em", mes_atual, ":", round(metricas_mes_atual$posicao_media, 2), "**\n\n")
  cat("**Melhoria na posição média (valor negativo indica melhoria):", round(comparacao$mudanca_posicao_media, 2), "**\n\n")
...
``` {r proporção de pareto}
# Páginas Responsáveis por 80% dos Cliques no Mês Atual

# Verificamos se temos pelo menos um mês de dados
if (length(meses) >= 1) {
